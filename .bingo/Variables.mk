...
BUILDINFO := $(GOBIN)/buildinfo-v0.0.0-20241226145521-389438021249
$(BUILDINFO): $(BINGO_DIR)/buildinfo.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/buildinfo-v0.0.0-20241226145521-389438021249"
	@cd $(BINGO_DIR) && GOWORK=off GOOS=$(GOHOSTOS) GOARCH=$(GOHOSTARCH) GOARM=$(GOHOSTARM) $(GO) build -mod=mod -modfile=buildinfo.mod -o=$(GOBIN)/buildinfo-v0.0.0-20241226145521-389438021249 "github.com/UiP9AV6Y/buildinfo/tools/cmd/buildinfo"
...
GOLANGCI_LINT := $(GOBIN)/golangci-lint-v2.9.0
$(GOLANGCI_LINT): $(BINGO_DIR)/golangci-lint.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/golangci-lint-v2.9.0"
	@cd $(BINGO_DIR) && GOWORK=off GOOS=$(GOHOSTOS) GOARCH=$(GOHOSTARCH) GOARM=$(GOHOSTARM) $(GO) build -mod=mod -modfile=golangci-lint.mod -o=$(GOBIN)/golangci-lint-v2.9.0 "github.com/golangci/golangci-lint/v2/cmd/golangci-lint"
